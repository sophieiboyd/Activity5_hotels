...
```{r plot, fig.width=10}
hotels$arrival_date_month <- fct_relevel(hotels$arrival_date_month, 'January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December')
